...
public class Yonatan extends Jugador {
	...
	public Yonatan(ArrayList<Animacion> animaciones) {
		super(animaciones);
	...
	public void trompon(){
		if(estaVivo()){
			if(this.getHorientacion()=="derecha"){
				this.setIndiceAnimacion(3);
			}else if(this.getHorientacion()=="izquierda"){
				this.setIndiceAnimacion(7);
			}
			atacar();
		}		
	}
	...
	public void patada(){
		if(estaVivo()){
			if (this.getHorientacion()=="derecha"){
				this.setIndiceAnimacion(4);
			}else if(this.getHorientacion()=="izquierda"){
				this.setIndiceAnimacion(8);
			}atacar();
		}		
	}
